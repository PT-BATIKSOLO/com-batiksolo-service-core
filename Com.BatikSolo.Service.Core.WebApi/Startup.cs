...
using Com.BatikSolo.Service.Core.Lib.Services.MachineSpinning;
...
namespace Com.BatikSolo.Service.Core.WebApi
{
    public class Startup
    {
        ...
        private void RegisterEndPoint()
        {
            ...
            Com.BatikSolo.Service.Core.Lib.Helpers.APIEndpoint.StorageAccountName = Configuration.GetValue<string>("StorageAccountName") ?? Configuration["StorageAccountName"];
            Com.BatikSolo.Service.Core.Lib.Helpers.APIEndpoint.StorageAccountKey = Configuration.GetValue<string>("StorageAccountKey") ?? Configuration["StorageAccountKey"];
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //    {
            //        options.ApiName = "com.BatikSolo.service";
