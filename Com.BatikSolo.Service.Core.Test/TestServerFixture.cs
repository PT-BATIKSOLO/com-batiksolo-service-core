...
using Com.BatikSolo.Service.Core.WebApi;
            ...
            IConfigurationRoot configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new List<KeyValuePair<string, string>>
                {
                    ...
                    */
                    ...
                    new KeyValuePair<string, string>("DefaultConnection", "Server=localhost,1401;Database=com.BatikSolo.db.core.controller.test;User=sa;password=Standar123.;MultipleActiveResultSets=true;")
