...
using Com.BatikSolo.Service.Core.Lib.Helpers.IdentityService;
using Com.BatikSolo.Service.Core.Lib.Helpers.ValidateService;
using Com.BatikSolo.Service.Core.Lib.Services;
using Com.BatikSolo.Service.Core.Lib.ViewModels.Expedition;
using Com.BatikSolo.Service.Core.WebApi.Controllers.v1.BasicControllers;
...
namespace Com.BatikSolo.Service.Core.Test.Controllers.MasterExpedition
{
    public class BasicTests
    {
        ...
        public Com.BatikSolo.Service.Core.Lib.Models.MasterExpedition GetTestData(CoreDbContext dbContext)
        {
            Com.BatikSolo.Service.Core.Lib.Models.MasterExpedition data = new Com.BatikSolo.Service.Core.Lib.Models.MasterExpedition();
        ...
        public void Get_Return_OK()
        {
            ...
            Com.BatikSolo.Service.Core.Lib.Models.MasterExpedition testData = GetTestData(dbContext);
        ...
        public void POST_BadRequest()
        {
            ...
            validateServiceMock.Setup(v => v.Validate(It.IsAny<Com.BatikSolo.Service.Core.Lib.Models.MasterExpedition>())).Verifiable();
