...
namespace Com.BatikSolo.Service.Core.Test
{
    public class ServiceProviderFixture : IDisposable
    {
        ...
        public ServiceProviderFixture()
        {
            IConfigurationRoot configuration = new ConfigurationBuilder()
                ...
                {
                    new KeyValuePair<string, string>("Secret", "BatikSoloTESTENVIRONMENT"),
					new KeyValuePair<string, string>("ASPNETCORE_ENVIRONMENT", "Test"),
                    new KeyValuePair<string, string>("DefaultConnection",  "Server=localhost,1401; Database = com.BatikSolo.db.core.service.test; User = sa; password = Standar123.; MultipleActiveResultSets = true; ")
                    //new KeyValuePair<string, string>("DefaultConnection", "Server=(localdb)\\mssqllocaldb;Database=com-BatikSolo-db-test;Trusted_Connection=True;MultipleActiveResultSets=true"),
